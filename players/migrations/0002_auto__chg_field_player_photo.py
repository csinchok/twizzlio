...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Player.photo'
        db.alter_column('players_player', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Player.photo'
        db.alter_column('players_player', 'photo', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))
