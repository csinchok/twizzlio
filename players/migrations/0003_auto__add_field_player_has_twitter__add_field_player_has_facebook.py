...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Player.has_twitter'
        db.add_column('players_player', 'has_twitter',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Player.has_facebook'
        db.add_column('players_player', 'has_facebook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Player.has_twitter'
        db.delete_column('players_player', 'has_twitter')

        # Deleting field 'Player.has_facebook'
        db.delete_column('players_player', 'has_facebook')
    ...
    models = {
        ...
        'players.player': {
            ...
            'has_twitter': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
